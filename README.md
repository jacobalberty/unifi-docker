...
| Tag | Description |
|-----|-------------|
| [`latest`, `stable`, `5.10`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Tracks UniFi stable version - 5.10.26 as of 2019-07-31 |
...
| Version | Latest Tag |
|---------|------------|
| 5.10.x   | [`5.10.26-sc`](https://github.com/jacobalberty/unifi-docker/blob/5.10.26-sc/Dockerfile) |
