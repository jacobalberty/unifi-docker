...
**The current "latest" version is Unifi Controller 7.3.81.
...
|-----|-------------|-----------|
| [`latest` `v7.3.81`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Current Stable: Version 7.3.81 as of 2023-02-08 |[Change Log 7.3.81](https://community.ui.com/releases/UniFi-Network-Application-7-3-83/88f5ff3f-4c13-45e2-b57e-ad04b4140528)|
