...
|-----|-------------|-----------|
| [`latest` `v8.0.26`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Current Stable: Version 8.0.26 as of 2024-01-05 |[Change Log 8.0.26](https://community.ui.com/releases/UniFi-Network-Application-8-0-26/cd9303a8-f26a-44e2-94d8-a3cac8606726)|
