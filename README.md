...
**The current "latest" version is Unifi Controller 7.3.76.
...
|-----|-------------|-----------|
| [`latest` `v7.3.76`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Current Stable: Version 7.3.76 as of 2022-12-06 |[Change Log 7.3.76](https://community.ui.com/releases/UniFi-Network-Application-7-3-76/85c75fc7-3e0f-4e99-aa90-7068af4f1141)|
