...
| Tag | Description |
|-----|-------------|
| [`latest`, `stable`, `5.11`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Tracks UniFi stable version - 5.11.46 as of 2019-09-16 |
...
| Version | Latest Tag |
|---------|------------|
| 5.11.x   | [`5.11.45-sc`](https://github.com/jacobalberty/unifi-docker/blob/5.11.45-sc/Dockerfile) |
