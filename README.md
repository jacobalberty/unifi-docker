...
| Tag | Description |
|-----|-------------|
| [`latest`, `stable`, `5.10`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Tracks UniFi stable version - 5.10.12 as of 2019-02-06 |
...
| 5.9.x   | [`5.9.29-sc`](https://github.com/jacobalberty/unifi-docker/blob/5.9.29-sc/Dockerfile) |
| 5.10.x   | [`5.10.12-sc`](https://github.com/jacobalberty/unifi-docker/blob/5.10.12-sc/Dockerfile) |
